...
class ROSInvariantsClassification:
    ...
    def angle_to_vertical_axis(self, traj_x, traj_y, traj_z):
        ...
        vertical_vector = np.array([0.05, 0.35, 0.45])
    ...
    def run(self):
        ...
        references[1] = 1.3*np.array([-1.053221, -0.922412, -0.391974, 0.729533, 2.538487, 4.851655, 7.073614, 8.322857, 7.943930, 6.293696, 4.106775, 2.219112, 0.952984, 0.213465, -0.106656])
